...
# Dockerfile...
ADD ./railyard.gemspec* /usr/src/app/
ADD ./lib/railyard/version.rb /usr/src/app/lib/railyard/version.rb
...
CMD ["/usr/src/app/bin/railyard", "create"]
